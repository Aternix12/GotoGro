...
//            'LastName' => ['required', 'regex:#^[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.\'-]+$#u', 'max:32'],
            ...
            // this is here just as another added layer of validaiton for the drop fown box fields.
            ...
            // error messages for data entry
                ...
                'Address.max' =>"Maximum of 320 characters.",
                'Email.email' => "Enter a vaild email adress you fool.",
                'Email.max' => "Maximum of 320 characters."
            ]
        );
       
        Member::create($request->all());
        return redirect()->route('members.index');
        // return response()->json(['message'=> 'Member added successfully. See Members page for all members.']);
    }
